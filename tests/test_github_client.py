...
class TestGitHubClient:
    ...
    def test_test_connection_success(
        self, mock_github_class, temp_db, mock_github_user
    ):
    ...
    @patch.dict(os.environ, {"GITHUB_TOKEN": "test_token"})
    @patch("wins_finder.integrations.github_client.Github")
    def test_get_activity_cached(
        self, mock_github_class, temp_db, sample_github_activity, date_range
    ):
    ...
    @patch.dict(os.environ, {"GITHUB_TOKEN": "test_token"})
    @patch("wins_finder.integrations.github_client.Github")
    def test_get_activity_fresh_data(
        self, mock_github_class, temp_db, date_range, mock_github_api
    ):
    ...
    @patch.dict(os.environ, {"GITHUB_TOKEN": "test_token"})
    @patch("wins_finder.integrations.github_client.Github")
    def test_get_activity_rate_limit_exceeded(
        self, mock_github_class, temp_db, date_range
    ):
    ...
    def test_get_pull_requests_empty(self, temp_db, mock_github_api):
        ...
        prs = client._get_pull_requests(
            mock_github_api, "testuser", start_date, end_date
        )
    ...
    def test_get_commits_empty(self, temp_db, mock_github_user):
        ...
        commits = client._get_commits(
            mock_github, mock_github_user, start_date, end_date
        )
    ...
    def test_get_issue_comments_empty(self, temp_db, mock_github_api):
        ...
        comments = client._get_issue_comments(
            mock_github_api, "testuser", start_date, end_date
        )
