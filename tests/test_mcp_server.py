...
class TestMCPServerTools:
    ...
    def test_test_authentication_with_token(self):
        ...
        assert "environment variable found" in result or "Connected" in result or "Failed" in result
    ...
    def test_analyze_weekly_wins_success(self, mock_db, mock_analyzer, mock_notion, mock_linear, mock_github):
    ...
    def test_analyze_weekly_wins_service_error(self, mock_github):
        ...
        with patch('wins_finder.mcp.server.linear') as mock_linear, \
    ...
    def test_collect_activity_data_success(self, mock_notion, mock_linear, mock_github):
        ...
        # Mock service responses
        mock_github.get_activity.return_value = {"activities": [1, 2, 3], "from_cache": False}
        ...
        result = collect_activity_data("last_week", ["github", "linear", "notion"], True)
    ...
    def test_post_to_slack_success(self, mock_slack):
        ...
        mock_slack.post_message.assert_called_once_with("Test message", channel="general")
